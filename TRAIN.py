...
Train_Image_Dir="Train_Image_Dir" # Images and labels for training
Train_Label_Dir="Train_Label_Dir"# Annotetion in png format for train images and validation images (assume the name of the images and annotation images are the same (but annotation is always png format))
UseValidationSet=False# do you want to use validation set in training
Valid_Image_Dir="Train_Image_Dir/"# Validation images that will be used to evaluate training
Valid_Labels_Dir="Train_Label_Dir/"#  (the  Labels are in same folder as the training set)
logs_dir= "logs/"# "path to logs directory where trained model and information will be stored"
if not os.path.exists(logs_dir): os.makedirs(logs_dir)
model_path="./vgg16.npy"# "Path to pretrained vgg16 model for encoder"
...
MAX_ITERATION = int(1000) # Max  number of training iteration
